...
export default function index() {
    return <>
    <Head>
            <title>Duff Wang | Senior Frontend Engineer</title>
        <meta name="viewport" content="initial-scale=1.0, width=device-width" />
        <meta name="description" content="Duff's portfolio. I solve problems using code (Mostly web). Engineer from Somewhere and everywhere."/>
